...
Prioritize confidence value from Pattern level in Issue records but fall back to
...
Update dependencies. Resolves an issue with some xpath queries via AppInspector
